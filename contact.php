                ...
                <div class="header__left">
                    ...
                    <div class="header__base-info">
                        ...
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/luiz-guilherme-a366b224/" target="_blank">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/lgvnunes" target="_blank">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/lugui_nunes" target="_blank">
